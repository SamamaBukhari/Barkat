...
public class Item {
    ...
    public static ArrayList<Item> getTestingList() {
        ...
        items.add(new Item("", "Yes", "CHICKEN BIRYANI", "", 3, "TODAY", "05:10 PM"));
        items.add(new Item("", "No", "CUPCAKES", "", 10, "TODAY", "11:10 AM"));
        items.add(new Item("", "Yes", "BREAD", "", 1, "YESTERDAY", "07:11 PM"));
        items.add(new Item("", "Yes", "FISH", "", 8, "2nd December", "4:15 AM"));
        items.add(new Item("", "No", "PIZZA", "", 3, "5th December", "06:15 PM"));
        return items;
