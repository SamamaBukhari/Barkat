...
public class Main4Activity extends AppCompatActivity implements VerticalStepperForm, IPickResult {
    ...
    private View createImageStep() {
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PickImageDialog.on(Main4Activity.this, new PickSetup());
...
//                checkDays();
    ...
    private View createAlarmTimeStep() {
        ...
        dateTextView = (TextView) timeStepContent.findViewById(R.id.date);
