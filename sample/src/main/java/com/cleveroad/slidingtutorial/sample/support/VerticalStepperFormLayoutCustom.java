 ...
 */
public class VerticalStepperFormLayoutCustom extends RelativeLayout implements View.OnClickListener {
    ...
    public VerticalStepperFormLayoutCustom(Context context) {
        super(context);
        init(context);
    }

    public VerticalStepperFormLayoutCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public VerticalStepperFormLayoutCustom(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     *
     * @deprecated use {@link Builder#newInstance(VerticalStepperFormLayoutCustom, String[], VerticalStepperForm, Activity)} instead like this:
     * <blockquote><pre>
     * VerticalStepperFormLayoutCustom.Builder.newInstance(verticalStepperFormLayout, stepsTitles, verticalStepperForm, activity)<br>
    ...
    protected void setUpStepLayoutAsConfirmationStepLayout(LinearLayout stepLayout) {
        ...
        confirmationButton.setText(R.string.vertical_form_stepper_form_confirm_button_custom);
    ...
    public static class Builder {
        ...
        // Required parameters
        protected VerticalStepperFormLayoutCustom verticalStepperFormLayout;
        ...
        protected Builder(VerticalStepperFormLayoutCustom stepperLayout,
                          String[] steps,
         ...
         */
        public static Builder newInstance(VerticalStepperFormLayoutCustom stepperLayout,
                                          String[] stepTitles,
                                          VerticalStepperForm stepperImplementation,
                                          Activity activity) {
